...
namespace QLDoAn.Areas.Teacher.Controllers
{
    public class SearchController : Controller
    {
        ...
        public async Task<JsonResult> Result_SinhVien(string tensinhvien)
        {
            db.Configuration.ProxyCreationEnabled = false;

            var model = await (from thamgia in db.Tbl_ThamGia
                               ...
                               {
                                   TenSinhVien = sv.TenSinhVien ?? string.Empty,
                                   TenDoAn = doan.TenDoAn ?? string.Empty,
                                   ChuyenNganh = sv.Tbl_ChuyenNganh.ChuyenNganh ?? string.Empty,
                                   DotBaoVe = thamgia.Tbl_NamBaoVe.DotBaoVe ?? 0,
                                   NamBaoVe = thamgia.Tbl_NamBaoVe.NamBaoVe ?? 0
                               }).ToListAsync();
